...
export const MODULE_GRANTS: { permission: string; label: string }[] = [
  ...
  { permission: 'media:read', label: 'Médiathèque — voir' },
  { permission: 'media:contribute', label: 'Médiathèque — ajouter' },
  { permission: 'media:manage', label: 'Médiathèque — gérer (galeries)' },
